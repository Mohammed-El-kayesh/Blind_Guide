    ...
    return  Sizer(
          builder: (context, orientation, deviceType) {
            return MaterialApp(
                ...
                home: isOnBoarding==null? Directionality(textDirection: TextDirection.rtl,child: OnBoarding()): Directionality(textDirection: TextDirection.rtl,child: PageViewScreen(),),
            );
          }
      );
